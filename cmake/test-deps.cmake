...
#
#   tanh_fetch_googletest([VERSION <tag>])       -> targets gtest, gtest_main, gmock, gmock_main;
#                                                   include(GoogleTest) done (gtest_discover_tests)
#   tanh_fetch_googlebenchmark([VERSION <tag>])  -> targets benchmark, benchmark_main
...
# them first), SYSTEM include directories, warnings off, PIC on, install off, dashboard
# targets suppressed (CTEST_TARGETS_ADDED). The dependencies' own options are steered
